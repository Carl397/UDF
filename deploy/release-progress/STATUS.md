...
Last updated: 2026-09-19. Overall status: RESIDENT REPORTS PRODUCTION DEPLOYMENT COMPLETE. Release `udf-20260919T021239Z`, source commit `947dc46337b3feb229e9ffce5c0cdd74824bc191`, is live at `https://crm.udf-party.co.za/crm/resident-reports/`. Migration 030, API/database health, public HTTPS content, backups, and upload preservation are verified. Interactive browser verification is blocked by the login page (no usable signed-in session). Android/Play artifacts were not rebuilt or published in this deployment; their separate historical status and blockers remain below.
...
- Receipt: `.tmp-verify/release-latest.json`; immutable manifest: `.tmp-verify/udf-20260919T021239Z/artifacts/release.json`. Backend SHA-256 `993e31cb9da52e14dd72c51ef96f68be1a5866ce590a9a5c8e0b819369c04c44`; frontend SHA-256 `6ae3a1eb5a9badf975a5f7b60930365960a1dc4a4064374369c95e81632b2623`.
...
## Deployment safety
Target: `102.68.98.129`. Live backend: `/opt/udf/backend`; live frontend: `/var/www/udf/frontend`. Latest deployment and recovery locations are recorded in the Resident Reports section above. The earlier CRM deployment completed at server journal time `2026-09-18 07:03:46 UTC`.
